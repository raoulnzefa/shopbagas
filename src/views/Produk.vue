                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/Shopcart"  class="primary-btn pd-cart"><i class="fa fa-shopping-basket"> </i> Add To Cart</router-link>
...
import shopbagas from '@/components/shopbagas.vue'

import footerbagas from '@/components/footerbagas.vue'
import bagproduk from '@/components/bagproduk.vue'
